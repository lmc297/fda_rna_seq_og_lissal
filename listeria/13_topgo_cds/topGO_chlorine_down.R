...
# plot results
pdf(file = "go_chlorine_bp_down.pdf", width = 11, height = 8.5)
bgc.bp.result$plot
dev.off()
...
# plot results
pdf(file = "go_chlorine_mf_down.pdf", width = 11, height = 8.5)
bgc.mf.result$plot
dev.off()
...
# save results as TSV
write.table(x = final.df, file = "go_chlorine_down.tsv",
            append = F, quote = F,
