...
deseq.ultra <- read.delim(file = "../13_topgo_cds/annot_deseq_ultrasound_vs_water.tsv",
                          header = T, sep = "\t",
                          stringsAsFactors = F,
                          check.names = F)
head(deseq.ultra)
...
deseq.chlor <- read.delim(file = "../13_topgo_cds/annot_deseq_chlorine_vs_water.tsv",
                          header = T, sep = "\t",
                          stringsAsFactors = F,
                          check.names = F)
head(deseq.chlor)
...
deseq.chlorultra <- read.delim(file = "../13_topgo_cds/annot_deseq_chlorine-ultrasound_vs_water.tsv",
                          header = T, sep = "\t",
                          stringsAsFactors = F,
                          check.names = F)
...
# save TSV file
write.table(x = final.pathway.up, file = "salmonella_kegg_pathway_up.tsv",
...
# save TSV file
write.table(x = final.pathway.down, file = "salmonella_kegg_pathway_down.tsv",
            append = F, quote = F, sep = "\t",
            row.names = T, col.names = T)
...
# save TSV file
write.table(x = final.pathway.gsea, file = "salmonella_kegg_pathway_gsea.tsv",
            append = F, quote = F, sep = "\t",
            row.names = T, col.names = T)
...
# save TSV file
write.table(x = final.module.up, file = "salmonella_kegg_module_up.tsv",
            append = F, quote = F, sep = "\t",
            row.names = T, col.names = T)
...
# save TSV file
write.table(x = final.module.down, file = "salmonella_kegg_module_down.tsv",
            append = F, quote = F, sep = "\t",
            row.names = T, col.names = T)
...
# save TSV file
write.table(x = final.module.gsea, file = "salmonella_kegg_module_gsea.tsv",
            append = F, quote = F, sep = "\t",
            row.names = T, col.names = T)
...
pdf(file = "plot_pathway_overrep.pdf",width = 15, height = 8.5)
