...
crf.og <- read.delim(file = "../annot_deseq_chlorine-ultrasound_vs_water.tsv", 
                  header = T, sep = "\t", 
                  stringsAsFactors = F, 
...
# plot results
pdf(file = "go_chlorine-ultrasound_bp_down.pdf", width = 11, height = 8.5)
bgc.bp.result$plot
dev.off()
...
# plot results
pdf(file = "go_chlorine-ultrasound_mf_down.pdf", width = 11, height = 8.5)
bgc.mf.result$plot
dev.off()
...
# plot results
pdf(file = "go_chlorine-ultrasound_cc_down.pdf", width = 11, height = 8.5)
bgc.cc.result$plot
dev.off()
...
# save results as TSV
write.table(x = final.df, file = "go_chlorine-ultrasound_down.tsv",
            append = F, quote = F,
