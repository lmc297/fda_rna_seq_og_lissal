...
# plot results
pdf(file = "go_chlorine-ultrasound_bp_up.pdf", width = 11, height = 8.5)
bgc.bp.result$plot
dev.off()
...
# plot results
pdf(file = "go_chlorine-ultrasound_mf_up.pdf", width = 11, height = 8.5)
bgc.mf.result$plot
dev.off()
...
# plot results
pdf(file = "go_chlorine-ultrasound_cc_up.pdf", width = 11, height = 8.5)
bgc.cc.result$plot
dev.off()
...
# save results as TSV
write.table(x = final.df, file = "go_chlorine-ultrasound_up.tsv",
            append = F, quote = F,
