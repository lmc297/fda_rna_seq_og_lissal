...
# plot results
pdf(file = "bakers_gamma_permutation_averageVSward.pdf", width = 8.5, height = 11)
...
# plot the tanglegram
pdf(file = "tanglegram_averageVSward.pdf", width = 11, height = 8.5)
...
pdf(file = "bakers_gamma_permutation_averageVSward_bootstrap.pdf", width = 8.5, height = 11)
par(mfrow = c(1,1))
plot(density(cor_bakers_gamma_results),
...
pdf(file = "Bk_plot_averageVSward.pdf", width = 8.5, height = 8.5)
